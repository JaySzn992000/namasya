...
naviTshirt("/FloralSarees");
};


const naviShirt = useNavigate();
const naviGateShirt = () => {
naviShirt("/PastelSarees");
};

const naviJeans = useNavigate();
const naviGateJeans = () => {
naviJeans("/SequinsSarees");
};
...
<a onClick={naviToCollection}  href="">SALE</a>
...
<a href="">Floral Sarees</a>
</li>
<li onClick={naviGateShirt}>
<a href="">Pastel Sarees</a>
</li>
<li onClick={naviGateJeans}>
<a href="">Sequins Sarees</a>
</li>
{/* <li onClick={naviGatePants}>
<a href="">Stonework Sarees</a>
</li> */}
